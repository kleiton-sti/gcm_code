...
return [
    ...
    | utilizadas pela classe de validação. Algumas dessas regras possuem
    ...
    */
    ...
    'max_digits' => 'O campo :attribute não deve possuir mais de :max dígitos.',
    ...
    'min_digits' => 'O campo :attribute deve possuir pelo menos :min dígitos.',
    'missing' => 'O campo :attribute deve estar ausente.',
    'missing_if' => 'O campo :attribute deve estar ausente quando :other for :value.',
    'missing_unless' => 'O campo :attribute deve estar ausente, a menos que :other esteja presente.',
    ...
    'password' => [
        ...
        'uncompromised' => 'A :attribute informada apareceu em um vazamento de dados. Escolha uma :attribute diferente.',
    ],

    'present' => 'O campo :attribute deve estar presente.',
    'present_if' => 'O campo :attribute deve estar presente quando :other for :value.',
    'present_unless' => 'O campo :attribute deve estar presente, a menos que :other esteja presente.',
    ...
    'prohibited_unless' => 'O campo :attribute é proibido, a menos que :other esteja entre :values.',
    'prohibits' => 'O campo :attribute impede que :other esteja presente.',
    'regex' => 'O formato do campo :attribute é inválido.',
    'required' => 'O campo :attribute é obrigatório.',
    'required_array_keys' => 'O campo :attribute deve conter as seguintes entradas: :values.',
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui você pode especificar mensagens de validação personalizadas
    | para atributos utilizando a convenção "attribute.rule". Isso
    | permite definir rapidamente uma mensagem específica para uma
    | determinada regra de validação.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de idioma abaixo são utilizadas para substituir o
    | placeholder do atributo por um nome mais amigável.
    |
    */
